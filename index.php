<?php
/*
 * Plugin Name: PrivacyPillar GDPR CCPA compliance
 * Description: This plugin provides you with the easiest way to insert the JavaScript for implementing PrivacyPillar’s Cookie Banner and providing the network path to get cookie consent records from your website users.
 * Version: 1.0.0
 * Author: PrivacyPillar
 * Author URI: https://privacypillar.com/
 * Text Domain: privacypillar-gdpr
 * License: GPL-2.0+
